import unittest
from katas.kyu_5.maximum_subarray_sum import max_sequence, max_sequence_second_solution, max_sequence_perfect_solution, max_sequence_simple_fast_solution
